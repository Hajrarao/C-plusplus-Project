            ...
            for (int i = 0; i < user.size(); i++)
            {
                if (user.at(i) == id && user.at(i + 1) == pas)
                {
                    ...
                    if (user.at(i - 1) == "P")
                    {
                        ...
                        count++;
                        system("cls");
                        cout << "\033[1mENCRYPT TECH\033[0m" << endl
                             << endl;
...
void display()
{
    cout << "\033[1mWELCOME TO ENCRYPT TECH\033[0m" << endl
         << endl;
    ...
    cout << "Functionality: Saves user data and exits the program.\nUser data is saved in a file or database to maintain user records." << endl
         << endl;
